 ...
 */
final class Version20210330022442 extends AbstractMigration
{
    ...
    public function up(Schema $schema) : void
    {
        ...
        $this->addSql('ALTER TABLE participation CHANGE video_id video_id INT DEFAULT NULL');
    ...
    public function down(Schema $schema) : void
    {
        ...
        $this->addSql('ALTER TABLE participation CHANGE video_id video_id INT DEFAULT 0');
