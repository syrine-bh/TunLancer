 ...
 */
final class Version20210329222001 extends AbstractMigration
{
    ...
    public function down(Schema $schema) : void
    {
        ...
        $this->addSql('ALTER TABLE post_like ADD CONSTRAINT FK_653627B82F23775F FOREIGN KEY (likes_id) REFERENCES utilisateurs (id) ON UPDATE NO ACTION ON DELETE NO ACTION');
