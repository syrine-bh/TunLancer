 ...
 */
final class Version20210325155008 extends AbstractMigration
{
    ...
    public function up(Schema $schema) : void
    {
        ...
        $this->addSql('ALTER TABLE topics ADD user_id INT DEFAULT NULL');
    ...
    public function down(Schema $schema) : void
    {
        ...
        $this->addSql('DROP INDEX IDX_91F64639A76ED395 ON topics');
        $this->addSql('ALTER TABLE topics DROP user_id');
    }
}
